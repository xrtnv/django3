...
from Catalog.views import ProductListView, ProductDetailView, ProductCreateView, BlogPostCreateView, BlogPostUpdateView, \
    BlogPostListView, BlogPostDetailView, BlogPostDeleteView, HomeView
